...
const Contact = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      action: "Email Us",
      link: "https://mail.google.com/mail/?view=cm&fs=1&to=pravin@evergrowdigital.com"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative pt-20 pb-8 bg-gradient-to-br from-brand-green-50 to-white">
