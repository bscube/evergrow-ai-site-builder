      ...
      <section className="py-24 bg-blue-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form className="space-y-6">
            ...
            {/* Second Row - Phone, Company, Job Title */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex">
                <select className="px-3 py-3 border border-grey-300 rounded-l-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-white">
                ...
                <input 
                  type="tel" 
                  placeholder="+91" 
                  className="flex-1 px-4 py-3 border border-l-0 border-grey-300 rounded-r-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                />
              </div>
              <div>
                <input 
