    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-grey-600">Official AI partner with Jio Haptik and certified partnerships with leading platforms</p>
        </div>
        <div className="flex flex-wrap items-center justify-center gap-12 opacity-70">
          <div className="flex items-center space-x-3">
            <div className="w-12 h-12 bg-gradient-to-r from-purple-600 to-blue-600 rounded flex items-center justify-center">
              <span className="text-white font-bold text-lg">JH</span>
            </div>
            <span className="text-lg font-semibold text-grey-700">Official Jio Haptik AI Partner</span>
          </div>
